...
<div class="content mt-3">
	...
	<div class="col-md-6">
			...
			<div class="form-group">
				<label>Title</label>
				<input type="text" class="form-control" value="Gallery list" placeholder="Enter Title">
				</div>
...
<script>
	...
	$(document).ready(function(){
     ...
     $("#add_row").click(function(){
      $('#addr'+i).html("<td><input name='name"+i+"' type='file'  class='form-control input-md'  /> </td>");
