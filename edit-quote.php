...
<div class="content mt-3">
    <div class="animated fadeIn">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <strong class="card-title">Add Quote</strong>
                    </div>
                    <div class="card-body">
		...
		<div class="col-md-6">
			...
			<div class="form-group">
				<label>Quote</label>
				<input type="text" class="form-control" placeholder="Enter quote" value="Success is not a good teacher, failure makes you humble.">
				</div>
