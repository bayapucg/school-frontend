    ...
    <div class="animated fadeIn">
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <strong class="card-title pull-left"><h4>Edit Lecturer</h4></strong><span class="valid"></span>
                    </div>
                    <div class="card-body">
			...
			<div class="form-group">
				<label>Title</label>
				<input type="text" class="form-control" value="lecturer list" placeholder="Enter Title">
				</div>
									...
									<table class="table table-bordered table-hover" id="tab_logic">
										...
										<tbody>
											<tr id='addr0'>
												...
												<td>
												<input type="text" name='name0'  placeholder='Enter Name' class="form-control"value="john"/>
												</td>
												<td>
												<input type="text" name='name0'  placeholder='Enter Designation' class="form-control" value="secretary"/>
												</td>
